...
<svelte:head>
  ...
  <meta name='description' content="An explanation of the ridgeline chart, a chart depicting tidal high/low predictions, and a part of tidal wave, a visual exploration of NOAA's high/low tidal projections">
</svelte:head>
